...
\verb![commit-ish]!      & An identifier that ultimately leads to a \texttt{commit} object. \\
...
\texttt{git commit -m <txt>} & Apply the staged modifications to \texttt{HEAD} \& make a new commit out of it. \\
\end{tabular}
\end{mdframed}
...
\texttt{git branch <br> [commit-ish]} & create a branch at [commit-ish].\\
\end{tabular}
\end{mdframed}
